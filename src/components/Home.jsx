...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-primary text-main">
      {/* profile Image  */}
      <img
        src={devPic}
        alt="My profile"
      ...
      <div className="mt-12">
        <a
          href="/resume_jun_swe-3.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-10 px-6 py-3 bg-white text-primary text-lg rounded-lg shadow-md hover:scale-105 transition-transform"
        >
          View Resume
        </a>
      </div>
